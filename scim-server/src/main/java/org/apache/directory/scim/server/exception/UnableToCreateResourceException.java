...
public class UnableToCreateResourceException extends ResourceException {
  ...
  public UnableToCreateResourceException(HttpStatus status, String message) {
    super(status.value(), message);
  }

  public UnableToCreateResourceException(HttpStatus status, String message, Throwable cause) {
